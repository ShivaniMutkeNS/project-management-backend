...
import com.example.pm.user.UserDTO.LoginRequest;
...
import com.example.pm.user.serviceimpl.UserDetailServiceImpl;
...
public class AuthController {
    ...
    public AuthController(UserRepository userRepository, PasswordEncoder passwordEncoder, UserDetailServiceImpl userDetailServiceImpl, SubscriptionService subscriptionService) {
